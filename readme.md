...
3. It should open your Labymod addon directory; Paste the [LabyGPT.jar](https://github.com/RappyLabyAddons/LabyGPT/releases/download/v1.0.0/LabyGPT.jar) in there.
